...
namespace Demo.COS
{
    class QCloudServer
    {
        ...
        public string secretId = "xxxxx"; //https://cloud.tencent.com/document/product/436/7751

        //开发者拥有的项目身份密钥,用以身份认证
        public string secretKey = "xxxx"; //https://cloud.tencent.com/document/product/436/7751

        //开发者访问 COS 服务时拥有的用户维度唯一资源标识，用以标识资源
        public string appid = "xx"; //https://cloud.tencent.com/document/product/436/7751
