...
namespace Demo.COS.Bucket
{
    class BucketSample
    {
        ...
        //public static void GetBucketPolicy(COSXML.CosXml cosXml, string bucket)
        //{
        //    try
        //    {
        ...
        //        request.SetSign(TimeUtils.GetCurrentTime(TimeUnit.SECONDS), 600);
        //        //执行请求
        //        GetBucketPolicyResult result = cosXml.GetBucketP(request);
        ...
        //public static void AsynDeleteBucketPolicy(COSXML.CosXml cosXml, string bucket)
        //{
        ...
        public static void DeleteBucketPolicy(COSXML.CosXml cosXml, string bucket)
        {
            try
            {
                DeleteBucketPolicyRequest request = new DeleteBucketPolicyRequest(bucket);
